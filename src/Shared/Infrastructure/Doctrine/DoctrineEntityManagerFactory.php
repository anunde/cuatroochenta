...
namespace Anunde\Shared\Infrastructure\Doctrine;

use Anunde\Shared\Infrastructure\Doctrine\Dbal\DbalCustomTypesRegistrar;
...
final class DoctrineEntityManagerFactory
{
	private static array $sharedPrefixes = [
		__DIR__ . '/../../../Shared/Infrastructure/Persistence/Mappings' => 'Anunde\Shared\Domain',
	];
