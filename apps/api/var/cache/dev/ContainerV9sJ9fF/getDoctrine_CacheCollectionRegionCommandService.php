 ...
 */
class getDoctrine_CacheCollectionRegionCommandService extends Anunde_Apps_Api_ApiKernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 6).'/vendor/doctrine/orm/src/Tools/Console/Command/ClearCache/CollectionRegionCommand.php';
