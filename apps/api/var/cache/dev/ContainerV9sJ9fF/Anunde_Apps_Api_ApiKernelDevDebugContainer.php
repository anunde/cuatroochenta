 ...
 */
class Anunde_Apps_Api_ApiKernelDevDebugContainer extends Container
{
    protected $targetDir;
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'Anunde\\Apps\\Api\\Controller\\LoginController' => 'getLoginControllerService',
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['Anunde\\Apps\\Api\\ApiKernel', 'Anunde\\Apps\\Api\\Controller\\LoginController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'debug.container.dump' => ($container->targetDir.''.'/Anunde_Apps_Api_ApiKernelDevDebugContainer.xml'),
        ...
        return [
            ...
            'kernel.bundles_metadata' => [
                ...
                'LexikJWTAuthenticationBundle' => [
                    'path' => (\dirname(__DIR__, 6).'/vendor/lexik/jwt-authentication-bundle'),
            ...
            'kernel.container_class' => 'Anunde_Apps_Api_ApiKernelDevDebugContainer',
            ...
            'doctrine.dbal.connection_factory.types' => [
                'user_id' => [
                    'class' => 'Anunde\\Api\\User\\Infrastructure\\Persistence\\Doctrine\\UserIdType',
                ],
            ],
