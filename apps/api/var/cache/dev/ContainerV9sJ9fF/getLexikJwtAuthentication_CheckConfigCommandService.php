 ...
 */
class getLexikJwtAuthentication_CheckConfigCommandService extends Anunde_Apps_Api_ApiKernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 6).'/vendor/lexik/jwt-authentication-bundle/Command/CheckConfigCommand.php';
