 ...
 */
class getNelmioApiDoc_Describers_OpenapiPhp_DefaultService extends Anunde_Apps_Api_ApiKernelDevDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 6).'/vendor/nelmio/api-doc-bundle/src/Util/SetsContextTrait.php';
        include_once \dirname(__DIR__, 6).'/vendor/nelmio/api-doc-bundle/src/Describer/OpenApiPhpDescriber.php';
