 ...
 */
class getSecurity_Command_UserPasswordHashService extends Anunde_Apps_Api_ApiKernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 6).'/vendor/symfony/password-hasher/Command/UserPasswordHashCommand.php';
