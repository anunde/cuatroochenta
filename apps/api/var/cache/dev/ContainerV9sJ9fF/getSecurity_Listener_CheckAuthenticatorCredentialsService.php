 ...
 */
class getSecurity_Listener_CheckAuthenticatorCredentialsService extends Anunde_Apps_Api_ApiKernelDevDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 6).'/vendor/symfony/security-http/EventListener/CheckCredentialsListener.php';
