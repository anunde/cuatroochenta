 ...
 */
class getDoctrine_Orm_DefaultEntityManagerService extends Anunde_Apps_Api_ApiKernelDevDebugContainer
{
    /**
    ...
    {
        if (true === $lazyLoad) {
            return $container->services['doctrine.orm.default_entity_manager'] = $container->createProxy('EntityManagerGhost38bf6c7', static fn () => \EntityManagerGhost38bf6c7::createLazyGhost(static fn ($proxy) => self::do($container, $proxy)));
        }
        ...
        include_once \dirname(__DIR__, 6).'/vendor/doctrine/orm/src/Mapping/Driver/LoadMappingFileImplementation.php';
        ...
        include_once \dirname(__DIR__, 6).'/vendor/doctrine/orm/src/Mapping/UnderscoreNamingStrategy.php';
        ...
        include_once \dirname(__DIR__, 6).'/vendor/doctrine/orm/src/Mapping/TypedFieldMapper.php';
        include_once \dirname(__DIR__, 6).'/vendor/doctrine/orm/src/Mapping/DefaultTypedFieldMapper.php';
        ...
        $c = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver([(\dirname(__DIR__, 6).'/src/Api/User/Infrastructure/Persistence/Doctrine') => 'Anunde\\Api\\User\\Domain\\Entity'], '.orm.xml', true);
        $c->setGlobalBasename('mapping');

        $b->addDriver($c, 'Anunde\\Api\\User\\Domain\\Entity');

        $a->setEntityNamespaces(['User' => 'Anunde\\Api\\User\\Domain\\Entity']);
