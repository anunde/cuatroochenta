 ...
 */
class getNelmioApiDoc_Controller_SwaggerUiService extends Anunde_Apps_Api_ApiKernelDevDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 6).'/vendor/nelmio/api-doc-bundle/src/Controller/SwaggerUiController.php';
