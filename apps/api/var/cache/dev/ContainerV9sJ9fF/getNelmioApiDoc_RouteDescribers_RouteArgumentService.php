 ...
 */
class getNelmioApiDoc_RouteDescribers_RouteArgumentService extends Anunde_Apps_Api_ApiKernelDevDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 6).'/vendor/nelmio/api-doc-bundle/src/RouteDescriber/RouteDescriberInterface.php';
        include_once \dirname(__DIR__, 6).'/vendor/nelmio/api-doc-bundle/src/Describer/ModelRegistryAwareInterface.php';
        include_once \dirname(__DIR__, 6).'/vendor/nelmio/api-doc-bundle/src/RouteDescriber/RouteDescriberTrait.php';
        include_once \dirname(__DIR__, 6).'/vendor/nelmio/api-doc-bundle/src/Describer/ModelRegistryAwareTrait.php';
        include_once \dirname(__DIR__, 6).'/vendor/nelmio/api-doc-bundle/src/RouteDescriber/RouteArgumentDescriber.php';
