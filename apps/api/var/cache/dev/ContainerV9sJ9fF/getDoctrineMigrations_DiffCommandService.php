 ...
 */
class getDoctrineMigrations_DiffCommandService extends Anunde_Apps_Api_ApiKernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 6).'/vendor/doctrine/migrations/src/Tools/Console/Command/DiffCommand.php';
