 ...
 */
class getNelmioApiDoc_Generator_DefaultService extends Anunde_Apps_Api_ApiKernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 6).'/vendor/nelmio/api-doc-bundle/src/ApiDocGenerator.php';
        include_once \dirname(__DIR__, 6).'/vendor/zircote/swagger-php/src/Generator.php';
        include_once \dirname(__DIR__, 6).'/vendor/nelmio/api-doc-bundle/src/Processor/NullablePropertyProcessor.php';
        include_once \dirname(__DIR__, 6).'/vendor/nelmio/api-doc-bundle/src/Processor/MapQueryStringProcessor.php';
        include_once \dirname(__DIR__, 6).'/vendor/nelmio/api-doc-bundle/src/Processor/MapRequestPayloadProcessor.php';
