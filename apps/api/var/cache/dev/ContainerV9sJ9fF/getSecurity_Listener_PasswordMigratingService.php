 ...
 */
class getSecurity_Listener_PasswordMigratingService extends Anunde_Apps_Api_ApiKernelDevDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 6).'/vendor/symfony/security-http/EventListener/PasswordMigratingListener.php';
