 ...
 */
class getNelmioApiDoc_Routes_DefaultService extends Anunde_Apps_Api_ApiKernelDevDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 6).'/vendor/symfony/routing/RouteCollection.php';
        include_once \dirname(__DIR__, 6).'/vendor/nelmio/api-doc-bundle/src/Routing/FilteredRouteCollectionBuilder.php';
